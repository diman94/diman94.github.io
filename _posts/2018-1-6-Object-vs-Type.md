...
Введем новый термин: Метакласс - это специальный класс, конструктор которого возвращает класс. То есть, связь метакласс->класс аналогична связи класс->объект. Тот факт, что классы являются экземплярами класса "type", позоволяет нам создавать свои метаклассы. Мы можем создавать классы, которые наследуются от класса "type". 
Напрашивается наивный вопрос: так то же главнее - type или object?
```
>>> type.__bases__
(<class 'object'>,)
>>> object.__bases__
